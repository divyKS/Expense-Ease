...
type DataCardProps = BoxVariants & IconVariants & {
    icon: IconType
    title: string
    value?: number
    dateRange: string
...
export const DataCard = ({ title, value = 0, percentageChange = 0, icon: Icon, variant, dateRange }: DataCardProps) => {
  return (
    <Card className="border-none drop-shadow-sm">
      <CardHeader className="flex flex-row items-center justify-between gap-x-4">
        ...
        <div className={cn(boxVariant({ variant }))}>
            {/* we capatalized Icon so that we could use it like a component */}
